...
export default async function BlogDetails({ params }: Props) {
  ...
  try {
    ...
    const html = generateHTML(blog.body, [StarterKit, TipTapImage]);
            ...
            {blog.src && (
              <div className='article-hero-image'>
                <Image
                  ...
                  // 既に最適化されたURLや data: の可能性があるなら unoptimized でOK
                  unoptimized
                />
              </div>
            )}
              ...
              <div className='article-info-section'>
                ...
                <div className='info-card tag-info'>
                  ...
                  blog.tag.length > 0 ? (
                    ...
                    <p>
                      カテゴリ: <span className='category-link'>{mainTag}</span>
                    </p>
                  )}
                  <p>
                    記事ID: <span className='article-id-full'>{blog.id}</span>
                  </p>
                </div>
              </div>
